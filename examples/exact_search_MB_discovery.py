...
from explora.information_theory.estimators import fraction_of_information_permutation, \
    ...
    mutual_information_permutation_upper_bound, conditional_fraction_of_information_permutation
...
result, score = greedy_search(mutual_information_permutation, data_mnist)
